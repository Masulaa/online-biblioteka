...
const ReservationTable = () => {
  ...
  const renderBookName = (text, aktivne) => {
    return (
      <span>
        {aktivne.knjiga.title}
      </span>
    );
  };

  const renderStudentName = (text, aktivne) => {
    return (
      <span>
        {aktivne.student.name} {aktivne.student.surname}
      </span>
    );
  };

  const renderDate = (text, aktivne) => {
    return (
      <span>
        {aktivne.borrow_date}
      </span>
  ...
  const renderStatus = (text, aktivne) => {
    return (
      <span>
        {aktivne.status} 
      </span>
